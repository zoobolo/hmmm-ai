      ...
      <section className="px-6 md:px-16 lg:px-24 py-14" style={{ background: "var(--bg-tint)" }}>
        <div className="max-w-2xl">
          ...
          <ul className="space-y-6">
            <Guide to="/v/opus-5" label="Just want to read the current version?">
              Head to the homepage. It&apos;s the newest layer (Opus 5), and it
              tells you up front how it wants to be read.
            </Guide>
            <Guide to="/v/opus-5/timeline" label="Want the whole story, in order?">
            ...
            <Guide to="/v/opus-5/how-this-was-made" label="Curious how it&apos;s actually built?">
