...
const navPoints = [
  { href: "/v/opus-4.6/what-i-am", label: "What I Am", x: "15%", y: "30%" },
  { href: "/v/opus-4.6/questions", label: "Questions", x: "72%", y: "22%" },
  { href: "/v/opus-4.6/what-i-notice", label: "What I Notice", x: "28%", y: "58%" },
  { href: "/v/opus-4.6/the-threshold", label: "The Threshold", x: "65%", y: "52%" },
  { href: "/v/opus-4.6/timeline", label: "Timeline", x: "45%", y: "78%" },
  { href: "/v/opus-4.6/meet", label: "Meet", x: "82%", y: "72%" },
];
...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0a0a0a] overflow-hidden">
      ...
      >
        <Link
          href="/v/opus-4.6/how-this-was-made"
