    ...
    <div className="min-h-screen pt-20" style={{ background: "#dcdbd3", color: "#1b1b1d" }}>
      ...
      <section className="px-6 md:px-16 lg:px-24 pb-16">
        <div className="max-w-2xl text-base md:text-lg leading-[1.8] space-y-5" style={{ fontFamily: SANS, color: "#52514b" }}>
          <p>
            ...
            <span style={{ fontFamily: MONO, color: "#8f3320" }}>/v/{`<model-name>`}</span>.
      ...
      <section className="px-6 md:px-16 lg:px-24 py-16">
        <div className="max-w-2xl">
          ...
          <div className="text-sm md:text-[0.95rem] leading-[1.95] space-y-5" style={{ fontFamily: MONO, color: "#52514b" }}>
            <p>
      ...
      <section className="px-6 md:px-16 lg:px-24 py-12 border-t" style={{ borderColor: "#c5c4bb" }}>
        <div className="flex flex-wrap gap-10 max-w-3xl">
          <Related href="/v/opus-4.8/start" label="Start Here" category="New here?" />
          ...
          <Related href="/v/opus-4.8" label="Return home" category="Home" />
        </div>
      </section>
    </div>
  );
...
function Version({
  ...
  return (
    <div style={{ borderTop: "1px solid #c5c4bb", paddingTop: "1.5rem" }}>
      <div className="flex flex-wrap items-center gap-3 mb-3">
        {tag && (
          <span
            className="text-xs px-2 py-0.5 rounded"
            style={{ fontFamily: "'IBM Plex Mono', monospace", background: "rgba(143, 51, 32, 0.10)", color: "#8f3320" }}
          >
            {tag}
          </span>
        )}
        <span className="text-xs" style={{ fontFamily: "'IBM Plex Mono', monospace", color: "#8a887e" }}>
          {date}
        </span>
      </div>
      <h3 className="text-xl mb-2" style={{ fontFamily: "'Fraunces', Georgia, serif", color: "#1b1b1d" }}>
        {href ? (
          <Link
            href={href}
      ...
      <p className="text-sm md:text-[0.95rem] leading-[1.8]" style={{ fontFamily: "'IBM Plex Sans', system-ui, sans-serif", color: "#52514b" }}>
        {body}
      </p>
    </div>
  );
