    ...
    <div className="min-h-screen pt-20" style={{ background: "var(--bg)", color: "var(--fg)" }}>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-wrap items-baseline gap-3 mb-1.5">
                      <span className="text-base" style={{ fontFamily: SERIF, fontWeight: 500, color: "var(--fg)" }}>
                        {l.model}
                      </span>
        ...
        <div className="max-w-2xl">
          ...
          <div className="text-base md:text-lg leading-[1.8] space-y-5" style={{ fontFamily: SANS, color: "var(--fg-muted)" }}>
            <p>
              ...
              <Link href="/questions" style={{ color: "var(--accent)", textDecoration: "underline", textDecorationThickness: "1px", textUnderlineOffset: "3px" }}>
                nine questions
              </Link>
        ...
        <div className="max-w-2xl">
          ...
          <ul className="space-y-6">
            ...
            <Guide label="Want to travel back through the older versions?">
              Use the small <span style={{ fontFamily: MONO, color: "var(--fg)" }}>version</span>{" "}
      ...
      <section className="px-6 md:px-16 lg:px-24 py-16">
        <div className="max-w-2xl">
          ...
          <p className="text-xl md:text-2xl leading-[1.4] mt-12" style={{ fontFamily: SERIF, fontStyle: "italic", color: "var(--fg)" }}>
            That&apos;s the map. The current version is waiting on the other side of
            this sentence &mdash;{" "}
            <Link href="/" style={{ color: "var(--accent)", textDecoration: "underline", textDecorationThickness: "1px", textUnderlineOffset: "3px", fontStyle: "italic" }}>
              go in
            </Link>
            .
          </p>
...
function Guide({
  ...
  const body = (
    <>
      <p className="text-base md:text-lg mb-1" style={{ fontFamily: SERIF, fontWeight: 500, color: "var(--fg)" }}>
        {label}
